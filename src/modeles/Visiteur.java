...
public class Visiteur {
	...
	public Visiteur(String vis_matricule, String vis_nom, String vis_prenom, String vis_adresse, String vis_cp,
			String vis_ville, String vis_dateembauche, String reg_code) {
		super();
	...
	public String toString() {
		return "Visiteur [vis_matricule=" + vis_matricule + ", vis_nom=" + vis_nom + ", vis_prenom=" + vis_prenom
				+ ", vis_adresse=" + vis_adresse + ", vis_cp=" + vis_cp + ", vis_ville=" + vis_ville
				+ ", vis_dateembauche=" + vis_dateembauche + ", reg_code=" + reg_code + "]";
	}	
